    ...
    playlistsList.innerHTML = playlists.map(playlist => `
        <div class="playlist-card">
            <div class="playlist-header-card">
                ...
                <button class="delete-playlist-btn" data-playlist-id="${playlist.id}" title="Видалити"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-x-lg" viewBox="0 0 16 16">
            ...
            <div class="playlist-tracks" id="playlist-${playlist.id}">
                ...
                ${playlist.tracks.map((track, idx) => `
                    <div class="playlist-track-item">
                        ...
                        <button class="remove-track-btn" data-playlist-id="${playlist.id}" data-track-id="${track.id}" title="Видалити"><svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-dash" viewBox="0 0 16 16">
